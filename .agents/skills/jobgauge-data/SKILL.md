...
Read `AGENTS.md` and `docs/DATA_TOOLS_AGENT_GUIDE.md`. Cite indicator id, series id, source/provider, units, frequency, seasonal adjustment, geography, and observation date. Keep query-time work offline and write requested exports under `exports/agent/`.
